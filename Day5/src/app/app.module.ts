...
import { CustomersComponent } from './components/masterdetailscommunication/assignment/customer.component';
import { OrdersComponent } from './components/masterdetailscommunication/assignment/order.component';
import { SearchComponent } from './components/masterdetailscommunication/assignment/search.component';
...
@NgModule({
  ...
  bootstrap: [ CustomersComponent,
    OrdersComponent,SearchComponent]
})
